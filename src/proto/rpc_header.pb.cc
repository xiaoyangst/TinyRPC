...
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_rpc_5fheader_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_rpc_5fheader_2eproto = nullptr;
const ::uint32_t
    TableStruct_rpc_5fheader_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::tinyrpc::RpcHeader, _impl_.service_name_),
        PROTOBUF_FIELD_OFFSET(::tinyrpc::RpcHeader, _impl_.method_name_),
        PROTOBUF_FIELD_OFFSET(::tinyrpc::RpcHeader, _impl_.method_args_),
};
...
const char descriptor_table_protodef_rpc_5fheader_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\020rpc_header.proto\022\007tinyrpc\"K\n\tRpcHeader"
    "\022\024\n\014service_name\030\001 \001(\014\022\023\n\013method_name\030\002 "
    "\001(\014\022\023\n\013method_args\030\003 \001(\014b\006proto3"
};
static ::absl::once_flag descriptor_table_rpc_5fheader_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_rpc_5fheader_2eproto = {
    false,
    false,
    112,
    descriptor_table_protodef_rpc_5fheader_2eproto,
    "rpc_header.proto",
    &descriptor_table_rpc_5fheader_2eproto_once,
    nullptr,
    0,
    1,
    schemas,
    file_default_instances,
    TableStruct_rpc_5fheader_2eproto::offsets,
    file_level_enum_descriptors_rpc_5fheader_2eproto,
...
inline PROTOBUF_NDEBUG_INLINE RpcHeader::Impl_::Impl_(
    ...
    const Impl_& from, const ::tinyrpc::RpcHeader& from_msg)
      : service_name_(arena, from.service_name_),
        method_name_(arena, from.method_name_),
        method_args_(arena, from.method_args_),
        _cached_size_{0} {}
...
const ::_pbi::TcParseTable<2, 3, 0, 0, 2> RpcHeader::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::tinyrpc::RpcHeader>(),  // to_prefetch
    ...
    // bytes method_args = 3;
    {::_pbi::TcParser::FastBS1,
     {26, 63, 0, PROTOBUF_FIELD_OFFSET(RpcHeader, _impl_.method_args_)}},
  }}, {{
    65535, 65535
  }}, {{
    // bytes service_name = 1;
    ...
    (0 | ::_fl::kFcSingular | ::_fl::kBytes | ::_fl::kRepAString)},
    // bytes method_args = 3;
    {PROTOBUF_FIELD_OFFSET(RpcHeader, _impl_.method_args_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kBytes | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
...
// @@protoc_insertion_point(message_clear_start:tinyrpc.RpcHeader)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* RpcHeader::_InternalSerialize(
          ...
          // bytes method_args = 3;
          if (!this_._internal_method_args().empty()) {
            const std::string& _s = this_._internal_method_args();
...
void RpcHeader::InternalSwap(RpcHeader* PROTOBUF_RESTRICT other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.method_args_, &other->_impl_.method_args_, arena);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_rpc_5fheader_2eproto),
         ::std::false_type{});
